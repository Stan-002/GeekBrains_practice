...
int userAx = Convert.ToInt32(Console.ReadLine(Работает));
int userAy = Convert.ToInt32(Console.ReadLine(Работает));

System.Console.WriteLine("Введите координаты точки B (x, y): ");
int userBx = Convert.ToInt32(Console.ReadLine(Работает));
int userBy = Convert.ToInt32(Console.ReadLine(Работает));
...
double rootXY = Math.Sqrt(squareX + squareY);//Math.Sqrt(Работает) находит квадратный корень
